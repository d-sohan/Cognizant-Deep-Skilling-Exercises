...
public class EmployeeManagementSystem {
    public static void main(String[] args) {
        ...
        Employee emp1 = new Employee("E001", "Sohan", "Manager", 75000);
        Employee emp2 = new Employee("E002", "Kiran", "Developer", 60000);
        Employee emp3 = new Employee("E003", "Charan", "Designer", 55000);
